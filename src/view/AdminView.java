...
public class AdminView extends Layout {
    ...
    private JButton btn_new_model;
    private JButton btn_new_brand;
    private JButton btn_new_car;
    ...
    public AdminView(User user) {
        ...
        btn_new_brand.addActionListener(new ActionListener() {
            @Override
        ...
        btn_new_model.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        btn_new_car.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
